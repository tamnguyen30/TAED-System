...
models = {
    'Naive Bayes':          ([0.60, 8.03, 20.40],  '#2ecc71', 'o', '-'),
    'Random Forest':        ([0.94, 9.83, 30.64],  '#27ae60', 's', '-'),
    'XGBoost':              ([4.88, 20.33, 37.93], '#f39c12', '^', '-'),
    'SVM':                  ([2.41, 25.69, 50.37], '#e74c3c', 'D', '-'),
    'Logistic Regression':  ([2.54, 26.09, 53.24], '#c0392b', 'v', '-'),
    'DistilBERT (retrained)': ([0.40, 3.41, 17.86], '#3498db', 'P', '--'),
    'TAED (Ours)':          ([0.60, 8.63, 25.35],  '#8e44ad', '*', '-'),
}
...
plt.tight_layout()
plt.savefig('/home/tamhmynguyen/TAED-System/results/figures/fig_attack_strength.png', 
            dpi=150, bbox_inches='tight')
plt.savefig('/home/tamhmynguyen/TAED-System/results/figures/fig_attack_strength.pdf', 
            bbox_inches='tight')
print('Saved!')